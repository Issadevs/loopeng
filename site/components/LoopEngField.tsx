...
// Decorative animated background for the hero: a sparse field of static loopeng
    ...
    >
      ...
      {CRITTERS.map((c, i) => {
        const style: CSSProperties = {
          ...
          color: c.color,
          lineHeight: 1.05,
          animation: `loopeng-orbit-${c.orbit} ${c.duration} ease-in-out infinite`,
