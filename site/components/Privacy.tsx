...
export default function Privacy() {
  const { privacy: privacyContent, sectionLabels, privacyCardTitle } = useContent();
  return (
    <section className="mx-auto w-full max-w-5xl px-6 py-20 sm:py-28">
      <div className="flex flex-col gap-4">
        <SectionLabel>{sectionLabels.privacy}</SectionLabel>
      ...
      <div className="mt-10">
        <TerminalCard title={privacyCardTitle}>
          <ul className="flex flex-col gap-1">
            {privacyContent.redacted.map((line, i) => {
              const last = i === privacyContent.redacted.length - 1;
              return (
